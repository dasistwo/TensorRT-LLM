...
protected:
    ...
    // dispatch_gemm_to_cutlass only considers 5 GEMM Figures.
    // Max values comes from CtaShape128x128x64_WarpShape128x32x64.
    // WarpShape::kM / 8 <= 16
    // static constexpr int MAX_K_ITERATION = 16;
    // WarpCount * OperatorCount * OperatorShape::kM * 16
    // max value comes from CtaShape128x128x64_WarpShape128x32x64
    // static constexpr int MAX_ACCUM_WORKSPACE = SPLIT_K_LIMIT * 4 * 128 * 256;
};
